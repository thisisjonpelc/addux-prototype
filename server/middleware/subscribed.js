    ...
    if (user.isAdmin) {
        ...
        try {
            ...
            subscriptions.forEach((subscription) => {
                if ((subscription.plan.id === process.env.INDIVIDUAL_PLAN_ID ||
                    ...
                    subscription.plan.id === process.env.INDIVIDUAL_COACHING_PLAN_ID ||
                    subscription.plan.id === process.env.CORPORATE_COACHING_PLAN_ID)
                    &&
