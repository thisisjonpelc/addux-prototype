...
router.patch('/users/subordinate', async (req, res) => {
    ...
    try {
        ...
        messageText[8] = `As part of your purchase you get a free strategy consultation call.  During this call we will establish a time for our recurring calls`;
