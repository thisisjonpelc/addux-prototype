        ...
        <form className="form form--600" onSubmit={this.onSubmit}>
          <div className="form__form-group">
            ...
            <input
              ...
              type="text"
              id="objective_prompt"
              value={this.state.objective_prompt}
              placeholder="Objective Prompt"
              onChange={this.objectivePromptChange}
            />
          </div>
          <div className="form__form-group">
            ...
            <input
              ...
              type="text"
              id="objective_video"
              value={this.state.objective_video}
              placeholder="Objective Video"
              onChange={this.objectiveVideoChange}
            />
          </div>
          <div className="form__form-group">
            <label htmlFor="goals_prompt">Results Prompt: </label>
            <input
              className="form__input"
              type="text"
              id="goals_prompt"
              value={this.state.goals_prompt}
              placeholder="Goals Prompt"
              onChange={this.goalsPromptChange}
            />
          </div>
          <div className="form__form-group">
            <label htmlFor="goals_video">Results Video Id: </label>
            <input
              className="form__input"
              type="text"
              id="goals_video"
              value={this.state.goals_video}
              placeholder="Goals Video"
              onChange={this.goalsVideoChange}
            />
          </div>
          <div className="form__form-group">
            <label htmlFor="projects_prompt">Deliverables Prompt: </label>
            <input
              className="form__input"
              type="text"
              id="projects_prompt"
              value={this.state.projects_prompt}
              placeholder="Projects Prompt"
              onChange={this.projectsPromptChange}
            />
          </div>
          <div className="form__form-group">
            <label htmlFor="projects_video">Deliverables Video Id: </label>
            <input
              className="form__input"
              type="text"
              id="projects_video"
              value={this.state.projects_video}
              placeholder="Projects Video"
              onChange={this.projectsVideoChange}
            />
          </div>
          <div className="form__form-group">
            ...
            <input
              ...
              type="text"
              id="timelines_prompt"
              value={this.state.timelines_prompt}
              placeholder="Timelines Prompt"
              onChange={this.timelinesPromptChange}
            />
          </div>
          <div className="form__form-group">
            ...
            <input
              ...
              type="text"
              id="timelines_video"
              value={this.state.timelines_video}
              placeholder="Timelines Video"
              onChange={this.timelinesVideoChange}
            />
          </div>
          <div className="form__form-group">
            ...
            <input
              className="form__input"
              type="text"
              id="projectOwner_prompt"
              value={this.state.projectOwner_prompt}
              placeholder="Project Owner Prompt"
              onChange={this.projectOwnerPromptChange}
            />
          </div>
          <div className="form__form-group">
            ...
            <input
              className="form__input"
              type="text"
              id="projectOwner_video"
              value={this.state.projectOwner_video}
              placeholder="Project Owner Video"
              onChange={this.projectOwnerVideoChange}
            />
          </div>
          <div className="form__form-group">
            ...
            <input
              ...
              type="text"
              id="resources_prompt"
              value={this.state.resources_prompt}
              placeholder="Resources Prompt"
              onChange={this.resourcesPromptChange}
            />
          </div>
          <div className="form__form-group">
            ...
            <input
              ...
              type="text"
              id="resources_video"
              value={this.state.resources_video}
              placeholder="Resources Video"
              onChange={this.resourcesVideoChange}
            />
          </div>
          <div className="form__form-group">
            ...
            <input
              ...
              type="text"
              id="progress_prompt"
              value={this.state.progress_prompt}
              placeholder="Progress Prompt"
              onChange={this.progressPromptChange}
            />
          </div>
          <div className="form__form-group">
            ...
            <input
              ...
              type="text"
              id="progress_video"
              value={this.state.progress_video}
              placeholder="Progress Video"
              onChange={this.progressVideoChange}
            />
          </div>
          <button className="btn btn--full-width">
            Submit new Walkthrough
          </button>
