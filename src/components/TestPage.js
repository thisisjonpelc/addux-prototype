    ...
    return (
        <div className='addux-pdf addux-pdf--page'>
            ...
            <div className='addux-pdf__columns'>
                ...
                <div className='pdf-column'>
                    <h1 className='pdf-column__header'>Timelines</h1>
                    <div className='pdf-column__boxes'>
                        <p className='pdf-column__box'>Test text</p>
                        <p className='pdf-column__box'>Test text</p>
                        <p className='pdf-column__box'>Test text</p>
                ...
                <div className='pdf-column'>
                    <h1 className='pdf-column__header'>Resources</h1>
                    <div className='pdf-column__boxes'>
                        <p className='pdf-column__box'>Test text</p>
                        <p className='pdf-column__box'>Test text</p>
                        <p className='pdf-column__box'>Test text</p>
                ...
                <div className='pdf-column'>
                    <h1 className='pdf-column__header'>Project Owner</h1>
                    <div className='pdf-column__boxes'>
                        <p className='pdf-column__box'>Test text</p>
                        <p className='pdf-column__box'>Test text</p>
                        <p className='pdf-column__box'>Test text</p>
                ...
                <div className='pdf-column'>
                    <h1 className='pdf-column__header'>Progress Updates</h1>
                    <div className='pdf-column__boxes'>
                        <p className='pdf-column__box'>Test text</p>
                        <p className='pdf-column__box'>Test text</p>
                        <p className='pdf-column__box'>Test text</p>
